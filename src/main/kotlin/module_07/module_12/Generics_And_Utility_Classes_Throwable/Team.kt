...
class Team(
    ...
    private val structure = mutableListOf<module_07.module_12.Generics_And_Utility_Classes_Throwable.AbstractWarrior>()
    init {
    ...
    private fun addWarrior(): module_07.module_12.Generics_And_Utility_Classes_Throwable.AbstractWarrior {
    ...
    fun getWarriorRandom(): module_07.module_12.Generics_And_Utility_Classes_Throwable.AbstractWarrior? {
